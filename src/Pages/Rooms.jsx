                    ...
                    <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
                        <thead>
                            <tr className="bg-blue-600 text-white">
                                ...
                                <th className="py-3 px-4 border-b border-gray-300 text-left">Room</th>
                                <th className="py-3 px-4 border-b border-gray-300 text-left">Available Rooms</th>
                                <th className="py-3 px-4 border-b border-gray-300 text-left">Max Guests</th>
                        ...
                        <tbody>
                            {rooms.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan="6" className="text-center py-4 text-gray-500">No rooms available</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
